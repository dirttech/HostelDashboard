...
<label id="subHeading" runat="server" style="font-size:small; " ></label>
   ...
   <li><a class="navy" onclick="pageLoad('CreateUser.aspx')">Create Group</a></li>
    <li><a class="navy" onclick="pageLoad('HostelMapper.aspx')">Add Groups & Rooms</a></li>
    <li><a class="navy" onclick="pageLoad('OccupantMapper.aspx')">Add Room Occupants</a></li>
