<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinalReport.aspx.cs" Inherits="FinalReport" %>
...
<input id="uid" type="hidden" runat="server" />
    ...
    <div id="reportBody" runat="server">
     ...
     <div id="printOptions" runat="server" style=" display:none; position:absolute; left:700px; top:120px;-moz-border-radius:8px;	-webkit-border-radius:8px;	
        border-radius:8px; box-shadow: 0px 0px 10px rgba(0,0,0,0.2); width:290px; height:170px;padding-left:10px; background-color:#6AAF5C; z-index:100;">
