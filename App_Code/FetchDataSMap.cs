...
namespace App_Code.FetchingEnergySmap
{
    ...
    public static class FetchEnergyDataS_Map
    {
        ...
        ///
        ///</summary> 
        public static void FetchAverageConsumption(string fromTimeArray, string toTimeArray, string location, List<int> meterIds, out Int32[] timeSt, out double[] values)
        {
            string stringData = "";
            timeSt = new int[meterIds.Count];
            values = new double[meterIds.Count];
            ...
            try
            {
                ...
                for (int j = 0; j < meterIds.Count; j++)
                {
                    ...
                    stringData = "apply energy_consumed to data in ('" + fromTimeArray + "','"+toTimeArray+"') limit -1 where Metadata/Location/Building ='" + location + "' and Metadata/Extra/PhysicalParameter='Energy' and Metadata/Extra/MeterID='"+meterIds[j]+"'";
        ...
        ///
        ///</summary> 
        public static void FetchAvgConsumptionWithMeterId(string[] fromTimeArray, string[] toTimeArray, string location, string meter_id, out Int32[] timeSt, out double[] values)
        {
            string stringData = "";
